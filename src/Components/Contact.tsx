    ...
    const contactMethods = [
        {
            ...
            ,
            contact: "Indraprastha Nagar, Pannase layout, Nagpur Maharashtra, India",
            title: "My Location"
        },
        {
            icon:
        ...
        },
        {
            ...
            ,
            contact: "Akhilesh2720@gmail.com",
            title: "Email"
        },
    ]

    return (
        <main className="pb-40 py-14">
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                <div className="w-full space-y-3">
                    ...
                    <p className="text-center">
                       I will love to connect with you, Here is my contacts..
                    </p>
                </div>
                <div>
